...
/**
 * Provides utility methods for managing database operations.
 * This class handles tasks such as connecting to the database,
 * executing queries, and performing CRUD (Create, Read, Update, Delete) operations.
 * It serves as an abstraction layer to simplify database interactions
 * and ensure efficient and secure data handling.
 */
class DatabaseHelper {
    ...
    /**
     * This method is responsible for getting the articles from the database
     * @param articleId
     * @return
     * @throws Exception
     */
    ...
    /**
     * This method is responsible for updating articles in the database
     * @param articleId
     * @param article
     * @throws Exception
     */
  ...
  /**
   * Method for creating a new table to put the information into
   * in case there is no table in the database.
   * @throws SQLException
   */
 ...
 // Method to display all users
    public void displayUsersByAdmin() throws Exception {
        ...
        while (rs.next()) { 
            ...
            // Print user details, including encrypted and decrypted passwords
            System.out.print("ID: " + id); 
            System.out.print(", Email: " + email); 
            System.out.print(", Encrypted Password: " + encryptedPassword); // This is the stored encrypted password
            System.out.print(", Decrypted Password: "); 
            EncryptionUtils.printCharArray(decryptedPassword); // Show the original password
